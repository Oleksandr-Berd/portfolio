...
const App: React.FC = (): JSX.Element => {
  ...
  const getAllProjects = async (args: IFetchProjects) => {
    ...
    setTotalProjects(result.data.allProjectsCount);
    setIsLoading(false);
  };
        ...
        {error ? (
          ...
          <Routes>
            <Route path="/" element={<SharedLayout />}>
              ...
              <Route
                path="admin/project"
                element={<AddProject submit={submitProjects} />}
              >
                <Route
                  path="images"
                  element={<AddImages submit={submitCoverImage} />}
                />
              </Route>
              <Route
                path="/:title"
                element={<ProjectDetails projects={projectBase.current} />}
              />
            </Route>
          </Routes>
        )}
